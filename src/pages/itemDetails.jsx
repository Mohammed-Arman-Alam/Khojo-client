...
const ItemDetails = ()=> {
    ...
    return (
        <div className="w-11/12 mx-auto my-10 rounded-2xl card card-side flex flex-col sm:flex-row shadow-sm bg-[#1E3A8A90]">
          <figure className='sm:w-6/13'>
            <img
              src={thumbnail}
              alt="Item Image" 
              className='rounded-xl sm:rounded-none object-fill'/>
          </figure>
