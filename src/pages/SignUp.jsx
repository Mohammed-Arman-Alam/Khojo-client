                ...
                <div className="hero-content flex-col md:flex-row md:justify-around w-11/12">
                    ...
                    <div className="card-body bg-[#1E3A8A60] rounded-xl">
                        <form onSubmit={handleRegister} className="fieldset">
                            ...
                            <button type='submit' className="btn mt-4 bg-[#FF9B51] font-bold text-white text-xl">Register</button>
                        </form>
                        ...
                        <p className='text-center'>Already have a account? 
                            <Link to="/login" className='text-[#1E3A8A] font-bold'>Login</Link>
                        </p>
                        <>
                            {
                                (errorMessage =="Firebase: Error (auth/email-already-in-use).") ?
                                (<p className='text-red-500'>Email already in use please <Link to="/Login" className='text-[#1E3A8A] font-bold'>login</Link> or use other email.</p>) 
                                : (
